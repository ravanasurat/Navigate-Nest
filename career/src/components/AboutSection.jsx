...
// Method 1: Import with relative path
import InstructorImg from "../assets/instructor.png";
import StudentImg from "../assets/student.png";

const AboutSection = () => {
  // Method 2: Define URLs as constants (if images are in public folder)
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-lg overflow-hidden shadow-md relative">
            {/* Try method 1 first (imported image) */}
            <img 
              src={InstructorImg} 
              ...
              onError={(e) => {
                ...
                // If that fails, try method 2 (public path)
