...
const Hero = () => {
  return (
    <div className="relative">
      {/* Teal background that ends with this section */}
        ...
        <div className="flex flex-col md:flex-row px-4 md:px-8 pt-8 pb-16 items-center max-w-7xl mx-auto">
          ...
          <div className="md:w-1/2">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              <span className="text-orange-500">Learning</span> Online is now<br />
              much easier
            </h1>
          ...
          {/* Right side content with student image and notifications */}
