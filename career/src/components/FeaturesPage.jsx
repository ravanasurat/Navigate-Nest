      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-20 gap-12">
        ...
        <div className="lg:w-1/2 relative">
          ...
          <div className="relative z-10 bg-gray-100 rounded-lg shadow-lg p-2 mx-auto max-w-lg">
            ...
            {/* Remove the grid structure and position each element individually */}
            <div className="relative pb-16">
              ...
              {/* Position videos with absolute positioning to match the image */}
              <div className="relative">
                {/* Taylor Curtis - top left */}
                ...
                {/* Richard Holland - bottom left - with offset */}
                ...
                {/* Patricia Mendoza - bottom right - with offset */}
              ...
              {/* Control Buttons - Positioned absolutely to match image */}
        ...
        <div className="lg:w-1/2 space-y-10 pl-12 mt-16 lg:mt-0">
          ...
          {/* Feature Items - Increased spacing to match image */}
